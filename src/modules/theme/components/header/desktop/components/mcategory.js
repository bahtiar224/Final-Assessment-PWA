                                ...
                                {val.link ? (
                                    <>
                                        <Link href={generateLink(val)[0]} as={generateLink(val)[1]}>
                                            <a style={{ fontSize: 12, fontWeight: 300 }} onClick={() => handleClick(val)} dangerouslySetInnerHTML={{ __html: val.name }} />
                                        </Link>
                                        {
                                    ...
                                    <a style={{ fontSize: 12, fontWeight: 300 }} href="#" dangerouslySetInnerHTML={{ __html: val.name }} />
                                ) }
