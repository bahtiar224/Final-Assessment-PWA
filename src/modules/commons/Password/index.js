...
const PasswordField = ({
    ...
    return (
        <TextField
            ...
            className={colors !== '' ? styles.labelWhite : styles.labelDefault}
            footer={
                showPasswordMeter && (
                    <>
                        <div className={styles.passwordStrength}>
                            ...
                            <div
                                className={classNames(
                                    colors !== '' ? styles.passwdStrPrgsCtrCustom : styles.passwdStrPrgsCtr,
                                    errorPaswd.status.toLocaleLowerCase()
                                        === 'no password'
                                        ? styles.full
                                        : errorPaswd.status.toLocaleLowerCase()
                ...
                showVisible && (
                    <InputAdornment position="end">
                        <IconButton
                            ...
                            className={classNames(colors !== '' ? styles.textWhite : styles.labelDefault)}
                        >
